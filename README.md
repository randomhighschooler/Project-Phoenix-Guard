...
### A Post-Quantum, GNSS-Denied UAV with Custom RISC-V Silicon Drone
...
### What makes everything even worse is that drone are like flying blocks of data. Encrypted transmissions, GPS signals all of it will be readable by a state that has a quantum computer. This project helps the transistion from vulnerable drones to quantem resistent ones by embedding Post-Quantum Cryptography (PQC) directly into the silicon.
